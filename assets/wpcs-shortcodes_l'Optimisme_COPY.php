...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) )  { 
	...
	$wpcs_cart_button_hover_font_color  = get_post_meta( $post_id, 'wpcs_cart_button_hover_font_color ', true );
	    ...
	    if($wpcs_display_header == "yes") { ?>
				<div class="another_carousel_header" id="wpcs-latest-title-wrapper" style="content: ''; background: #fff url(./wp-content/themes/estore-child/assets/images/Noel-band4.png) repeat 358px;	background-size: initial;">
					<!--
					- Changed <div> here to <h1> to change sizing issue in HTML of carousel
					- Change made Monday 28/11/2016 @ 14:31
					-->
					<h1 class="title" id="wpcs-latest-title-h1"style="font-size: <?php echo $wpcs_header_title_font_size; ?>; color: <?php echo $wpcs_header_title_font_color; ?>;"><?php echo $wpcs_title; ?></h1>
					<!--
					- End Change (above)
					-->
