...
?>
<?php
add_action( 'estore_after_header', 'my_test' );
function my_test() {
?>	
	<ul class="testis">
		<?php
	...
	$(document).ready(function() {
		...
		var hoverMenu1 = $(
		              ...
		              '<div class="col-xs-4">' +
		                ...
		                '<ul class="testis">' +
		                		"<?php global $product;?>" +
		                	    "<?php $args = array( 'post_type' => 'product', 'posts_per_page' => 10, 'product_cat' => 'maison' );?>" +
		                	    "<?php $loop = new WP_Query( $args ); ?>" +
		                	    "<?php $class = 'hovermenu-li'; ?>" +
		                		
		                		    "<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>" +
		                			 	"<?php echo '<li class="'.$class.'"><a href="'.get_permalink().'">'.get_the_title().'</a></li>'; ?>" +
		                	    	"<?php endwhile; ?>" +
